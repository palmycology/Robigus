...
#  titlePanel(
    div(
      ...
      h6("APS Plant Disease Notes 1980-2024", style="color: black; margin-top:5px;")
#    )
  ),
    ...
    sidebarPanel(
      ...
      wellPanel(
        style = "
              ...
              ",
        h4("About this App"),
        tags$p(HTML("<b>Creator:</b> Braham Dhillon, Assistant Professor")),
        tags$p(HTML("<b>Affiliation:</b><br>
                    ...
                    Davie, FL")),
        tags$p(HTML("<b>Contact:</b> <a href='mailto:dhillonb@ufl.edu'>you@email.com</a>"))
      )
    ),
