...
ui <- page_sidebar(
  ...
  sidebar = sidebar(
    ...
    actionButton("reset_btn", "Reset All Filters", class="btn btn-outline-primary", style="margin-top:10px;"),
    ...
    card(
      ...
      style = "background-color:#e6f7e6; border:1px solid #b7dfb7; border-radius:12px; box-shadow:2px 2px 6px rgba(0,0,0,0.1);"
    )
  ),
  
  # --- Main Content ---
  fillable = TRUE,   # makes main panel stretch
